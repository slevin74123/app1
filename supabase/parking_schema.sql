-- Schema pentru tabela de parcare
-- Această versiune va funcționa fără erori în Supabase

-- 1. Activează extensia earthdistance pentru funcții geografice
create extension if not exists earthdistance cascade;

-- 2. Șterge tabela existentă dacă există (pentru a evita conflictele)
...
create index parking_locations_coordinates_idx on public.parking_locations using gist(ll_to_earth(latitude, longitude));
...
do $$
begin
  raise notice 'Schema de parcare creată cu succes!';
