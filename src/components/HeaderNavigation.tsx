      ...
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" role="navigation" aria-label="Navigare principală">
        <div className="flex justify-between items-center h-14 sm:h-16">
          ...
          <div className="flex items-center space-x-2">
            ...
            <span className="text-lg sm:text-xl font-bold text-foreground">{logoText}</span>
          </div>
          ...
          <div className="hidden md:flex items-center space-x-6 lg:space-x-8">
            ...
            <div className="flex items-center space-x-2 lg:space-x-3">
              ...
              <Button size="sm" onClick={handleSignUpClick} className="text-sm font-medium rounded-full px-4 lg:px-6" aria-label="Înregistrare cont nou">
                Înregistrare
              </Button>
            </div>
          </div>
